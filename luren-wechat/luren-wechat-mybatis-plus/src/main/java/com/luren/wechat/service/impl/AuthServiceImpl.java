...
public class AuthServiceImpl implements IAuthService {
    ...
    public AuthWxUserDto login(AuthWxUserDto authWxUserDto) {
        if (!StringUtils.isEmpty(authWxUserDto.getCode())) {
            ...
            if (StringUtils.isEmpty(resultUser)) {
                ...
                String jsonRowData = authWxUserDto.getRawData();
                RowData rowData = JSONObject.parseObject(jsonRowData,RowData.class);
                resultUser.setNickName(rowData.getNickName());
                resultUser.setAvatarUrl(rowData.getAvatarUrl());
                resultUser.setCity(rowData.getCity());
                resultUser.setCountry(rowData.getCountry());
                resultUser.setProvince(rowData.getProvince());
                resultUser.setUpdateBy("system");
    ...
    public Boolean updateUser(AuthWxUserDto authWxUserDto) {
        ...
        return iWxUserService.update(user);
