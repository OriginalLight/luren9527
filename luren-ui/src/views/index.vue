        ...
        <a-col
          ...
          <a-card title="便捷导航" style="margin-bottom: 24px" :bordered="false" :body-style="{padding: 0}">
            <div class="item-group">
              <a href="http://ruoyi.vip/" target="_blank"></a>
          ...
          <a-card hoverable style="margin-bottom: 24px">
            <a href="https://github.com/fuzui/HealthPlatform" target="_blank" slot="cover">
              <img style="width:100%" src="https://github-readme-stats.vercel.app/api/pin/?username=fuzui&repo=HealthPlatform" >
            </a>
          </a-card>
          <!-- 贡献者 -->
